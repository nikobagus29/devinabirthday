...
@section('content')
    <section class="min-h-screen bg-gradient-to-b from-gray-100 to-white flex items-center justify-center p-6">
        <div
            ...
            <div class="absolute top-4 left-4 text-4xl text-pink-300 animate-float">💖</div>
            <div class="absolute top-8 right-8 text-3xl text-pink-300 animate-float animation-delay-1000">💕</div>
            <div class="absolute bottom-8 left-12 text-5xl text-pink-300 animate-float animation-delay-2000">💞</div>
            <div class="absolute bottom-4 right-4 text-2xl text-pink-300 animate-float animation-delay-1500">❤️</div>
