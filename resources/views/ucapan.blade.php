    ...
    <section id="wishes" class="py-20 bg-gradient-to-b from-[#f1ece3] to-[#f0ede9]">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-10">
                <!-- Kolom Pertama -->
                <div class="bg-[#ebd5c7] p-8 rounded-xl shadow-lg animate-slide-up">
                ...
                <!-- Kolom Kedua -->
                <div class="flex flex-col items-center justify-center bg-[#ebd5c7] p-8 rounded-xl shadow-lg animate-slide-up">
